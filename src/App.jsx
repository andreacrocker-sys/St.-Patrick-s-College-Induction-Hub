...
export default function App() {
  return (
    ...
    >
      ...
      >
        <FileDown style={{ verticalAlign: "middle", marginRight: "0.4rem" }} />
        Goal Setting Template
      </button>

      <button
        onClick={() =>
          makePdf("Peer Observation Form", [
      ...
      <button
        onClick={() =>
          makePdf("Post-Observation Reflection", [
      ...
      >
        Upload your crest later via the Admin section.
      </p>
    </div>
  );
}
